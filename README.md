...
Paket :
Java JDK 17+ (Menjalankan mesin utama Apktool)
Apktool (Dekompilasi dan Rebuild APK)
Binutils (Ekstraksi string dari library Native .so)
Apksigner (Menandatangani APK agar bisa diinstal)
